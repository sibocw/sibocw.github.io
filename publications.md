...
- I wrote a [tutorial on processing geospatial data with Python](https://github.com/yzh5239/geospatial-quickstart/blob/master/notebooks/1hr-cookbook.ipynb) (Caveat: I wrote this quite a while ago; it might not follow the up-to-date best practices and I was only a master student when I wrote it.)
